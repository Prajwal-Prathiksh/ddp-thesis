...
AM AND LM \figref{fig:ltgv-am-lm}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
...
KE AND DECAY \figref{fig:ltgv-ke-decay}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
...
P-L1 ERROR \figref{fig:ltgv-pl1}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
...
SCHEME - VMAG \figref{fig:ltgv-scheme-vmag}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
...
SCHEME - VORTICITY \figref{fig:ltgv-scheme-vorticity}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
