...
The evolution of the kinetic energy for the various schemes are shown in \figref{fig:tgv-forced-ke}.
...
ESPEC \figref{fig:tgv-forced-espec}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
...
COLAG - P \figref{fig:tgv-forced-colag-p}
\begin{figure}[htbp!]
\centering
...
COLAG - VMAG \figref{fig:tgv-forced-colag-vmag}
\begin{figure}[htbp!]
\centering
\begin{subfigure}{10cm}
...
COLAG - OMEGA \figref{fig:tgv-forced-colag-omega}
\begin{figure}[htbp!]
\centering
\begin{subfigure}{10cm}
...
The evolution of the angular and linear momentum for the various schemes are shown in \figref{fig:tgv-forced-am-lm}.

AM AND LM \figref{fig:tgv-forced-am-lm}
\begin{figure}[htbp!]
  \begin{subfigure}{7cm}
