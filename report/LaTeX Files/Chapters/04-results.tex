...
Since, the study dealt with problems of low $Re$, the scheme was tested over various time-integration schemes from the Runge-Kutta family of integrators, in order to identify their effects, and to subsequently identify the most suitable integrator for problems of high $Re$.
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}{7cm}
    ...
    \caption{$Re = 10000$}
  \end{subfigure}
  \caption{Convergence of the L-IPST-C scheme over various time-integration schemes}
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}{7cm}
    ...
    \caption{$Re = 10000$}
  \end{subfigure}
  \caption{Run-time (in $s$) of the L-IPST-C scheme over various time-integration schemes}
