...
The results are shown in \figref{fig:sph-eps-meps}. The first major observation here is that as the $Re$ increases, the OOC of the scheme increases, which is promising. Also, as the $\epsilon$ value increases, the magnitude of the $L_1$ error increases, but in the limit of $h \rightarrow 0$, the error appears to converge to a constant value. 
Interestingly, the $\epsilon$ value does not appear to have a significant effect on either the velocity magnitude field, as shown in \figref{fig:sph-eps-meps-vmag}, or the energy spectrum, as shown in \figref{fig:sph-eps-meps-espec}.
...
Similarly, a convergence study was performed to study the effects of the equation of state on the SPH-$\epsilon$ scheme. The results are shown in \figref{fig:sph-eps-eos}, where it can be observed that again, the nature of the equation of state does not affect the convergence of the scheme.
This is made evident by the both the velocity magnitude field, as shown in \figref{fig:sph-eps-eos-vmag}, and the energy spectrum, as shown in \figref{fig:sph-eps-eos-espec}, which do not appear to be significantly different for the two cases.
...
Finally, a convergence study was performed to study the effects of $f_{pst}$ on the SPH-$\epsilon$ scheme. From observing the results shown in \figref{fig:sph-eps-pst}, it can be observed large values of $f_{pst}$ reduces the magnitude of the $L_1$ error. However, like in the earlier case, the error appears to converge to a constant value in the limit of $h \rightarrow 0$.
Therefore, there is no significant effect of $f_{pst}$ on the velocity magnitude field, as shown in \figref{fig:sph-eps-pst-vmag}, or the energy spectrum, as shown in \figref{fig:sph-eps-pst-espec}.
