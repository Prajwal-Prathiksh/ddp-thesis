...
\cleardoublepage % Comment out if oneside is used
\includepdf[
  pages={1},
  pagecommand={\thispagestyle{plain}},
  addtotoc={1,chapter,1,Thesis Approval,thesis-approval}
]{Base/thesis-approval-180010027-signed-no-pagenum.pdf}
% \input{Base/thesis-approval.tex}


% Include declaration of authorship page
\cleardoublepage % Comment out if oneside is used
\includepdf[
  pages={1},
  pagecommand={\thispagestyle{plain}},
  addtotoc={1,chapter,1,Declaration of Authorship,thesis-declaration}
]{Base/thesis-declaration-180010027-signed-no-pagenum.pdf}
