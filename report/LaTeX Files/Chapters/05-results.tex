...
\begin{figure}[h]
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec_speedup_dim_1.png}
      \caption{$1D$ velocity field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec_speedup_dim_2.png}
      \caption{$2D$ velocity field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec_speedup_dim_3.png}
...
\begin{figure}[h]
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec-simple-1d/EK_spectrum.png}
      \caption{$1D$ $\vect{E}(\vect{k})$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec-simple-2d/EK_spectrum.png}
...
\begin{figure}[h]
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec-simple-1d/energy_spectrum.png}
      \caption{$1D$ $E(k)$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/espec-simple-2d/energy_spectrum.png}
      \caption{$2D$ $E(k)$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
        \centering\includegraphics[width=7cm]{Code-Figures/espec-simple-3d/energy_spectrum.png}
...
\begin{figure}[h]
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/sine-vel-prof-1d/EK_spectrum.png}
      \caption{$1D$ $\vect{E}(\vect{k})$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/sine-vel-prof-2d/EK_spectrum.png}
      \caption{$2D$ $\vect{E}(\vect{k})$ field}
    \end{subfigure}
...
\begin{figure}[h]
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/sine-vel-prof-1d/ek_00000_loglog.png}
      \caption{$1D$ $E(k)$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/sine-vel-prof-2d/ek_00000_loglog.png}
      \caption{$2D$ $E(k)$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
        \centering\includegraphics[width=7cm]{Code-Figures/sine-vel-prof-3d/ek_00000_loglog.png}
        \caption{$3D$ $E(k)$ field}
      \end{subfigure}
...
\begin{figure}[h]
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-pertub/Energy Spectrum (Loglog) (Dim=1, Nx=101, N_Freq=50).png}
      \caption{$1D$ $E(k)$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
      \centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-pertub/Energy Spectrum (Loglog) (Dim=2, Nx=101, N_Freq=50).png}
      \caption{$2D$ $E(k)$ field}
    \end{subfigure}
    \begin{subfigure}{8cm}
        \centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-pertub/Energy Spectrum (Loglog) (Dim=3, Nx=101, N_Freq=50).png}
        \caption{$3D$ $E(k)$ field}
      \end{subfigure}
...
\begin{itemize}
    \item \texttt{sph}:
    \begin{equation}
        \phi_i = \sum_{ij} \frac{m_j}{\rho_j} \phi_j \DWIJ,
    \end{equation}
    
    \item \texttt{shepard}:
    \begin{equation}
        \phi_i = \frac{\sum_{ij} \phi_j \WIJ}{\sum_{ij} \WIJ},
    \end{equation}
    ...
    \item \texttt{order1BL}: same as \Eqref{eq:interp-order1}, but with $\DWIJ$ term corrected using the Bonet-Lok correction, % TODO cite

    \item \texttt{order1MC}: same as \Eqref{eq:interp-order1}, but with $\DWIJ$ term corrected using the Morris-Cummins correction, % TODO cite
\end{itemize}
where $\phi$ is the quantity to be interpolated.
...
\begin{figure}[h]
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-i-methods/Energy Spectrum (Loglog) (Dim=1, Pertub=0.01).png}
		\caption{$1D$ $E(k)$ field}
	\end{subfigure}
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-i-methods/Energy Spectrum (Loglog) (Dim=2, Pertub=0.01).png}
		\caption{$2D$ $E(k)$ field}
	\end{subfigure}
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-i-methods/Energy Spectrum (Loglog) (Dim=3, Pertub=0.01).png}
		\caption{$3D$ $E(k)$ field}
	\end{subfigure}
...
\begin{figure}[h]
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-i-kernel/Energy Spectrum (Loglog) (Dim=1, Pertub=0.01, Method=Sph).png}
		\caption{$1D$ $E(k)$ field}
	\end{subfigure}
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-i-kernel/Energy Spectrum (Loglog) (Dim=2, Pertub=0.01, Method=Sph).png}
		\caption{$2D$ $E(k)$ field}
	\end{subfigure}
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-i-kernel/Energy Spectrum (Loglog) (Dim=3, Pertub=0.01, Method=Sph).png}
		\caption{$3D$ $E(k)$ field}
	\end{subfigure}
...
\begin{figure}[h]
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-res/Energy Spectrum (Loglog) (Dim=1, Pertub=0.01, Method=Sph, Kernel=Wqc6).png}
		\caption{$1D$ $E(k)$ field}
	\end{subfigure}
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-res/Energy Spectrum (Loglog) (Dim=2, Pertub=0.01, Method=Sph, Kernel=Wqc6).png}
		\caption{$2D$ $E(k)$ field}
	\end{subfigure}
	\begin{subfigure}{8cm}
		\centering\includegraphics[width=7cm]{Code-Figures/sin-vel-prof-res/Energy Spectrum (Loglog) (Dim=3, Pertub=0.01, Method=Sph, Kernel=Wqc6).png}
		\caption{$3D$ $E(k)$ field}
	\end{subfigure}
...
% Effect of perturbation, show which i-method is best
