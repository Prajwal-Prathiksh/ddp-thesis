...
def get_props(x, y, z, t, c0):
    ...
    u = (x**2*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + 1) * np.ones_like(x)
...
class AddMomentumSourceTerm(Equation):
    ...
    def post_loop(self, d_au, d_av, d_aw, d_idx, d_x, d_y, d_z, d_u, d_v, d_w,
        ...
        u = x**2*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + 1
        v = 0.0
        w = 0.0
        ...
        d_au[d_idx] += u*(x**2*y*(y - 1)*(-16000*t - 400*x + 40.0)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + 2*x*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y)) + v*(-2*pi*x**2*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*sin(2*pi*y) + x**2*y*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + x**2*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y)) + x**2*y*(y - 1)*(-640000*t - 16000*x + 1600.0)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) - 4*pi*sin(4*pi*x)/rhoc
...
class SetValuesonSolid(Equation):
    ...
    def initialize(
        ...
        d_gradv[idx9] = x**2*y*(y - 1)*(-16000*t - 400*x + 40.0)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + 2*x*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y)
        d_gradv[idx9 + 1] = -2*pi*x**2*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*sin(2*pi*y) + x**2*y*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + x**2*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y)
        d_gradv[idx9 + 2] = 0
        d_gradv[idx9 + 3] = 0
        d_gradv[idx9 + 4] = 0
        d_gradv[idx9 + 5] = 0
...
class AddContinuitySourceTerm(Equation):
    ...
    def post_loop(self, d_arho, d_idx, d_x, d_y, d_z, d_u, d_v, d_w, d_rho,
        ...
        d_arho[d_idx] += rhoc*(x**2*y*(y - 1)*(-16000*t - 400*x + 40.0)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + 2*x*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y)) - 4*pi*u*sin(4*pi*x)/c0**2 - 4*pi*v*sin(4*pi*y)/c0**2
...
class AddPressureEvolutionSourceTerm(Equation):
    ...
    def post_loop(self, d_ap, d_idx, d_x, d_y, d_z, d_u, d_v, d_w, d_rho,
        ...
        d_ap[d_idx] += 400*rhoc*(x**2*y*(y - 1)*(-16000*t - 400*x + 40.0)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y) + 2*x*y*(y - 1)*exp(-320000*(t + x/40 - 0.0025)**2)*cos(2*pi*y)) - 4*pi*u*sin(4*pi*x) - 4*pi*v*sin(4*pi*y)
