...
\end{equation}
where $t*=tU/L$, $\vect{x}^* = \vect{x}/L$, and $A=1.3*U^2/L$. $U$ and $L$ are the characteristic velocity and length scales of the system, respectively.
...
The authors, simulated this problem for a Reynolds number range of $Re = [10^4, 10^5, 10^6]$, with a resolution of $N=1200^2$, using an \texttt{RK4} time integrator, and a \texttt{WendlandQuinticC2} kernel.
