...
Since, the study dealt with problems of low $Re$, the scheme was tested for various time-integrators from the Runge-Kutta family of integrators, in order to identify their effects, and to subsequently identify the most suitable integrator for problems of high $Re$.
...
Subsequently, in order to test for the effects of the PST on the scheme, multiple values of $f_{pst}$ were considered, and the results are shown in \figref{fig:deltales-pst}.
...
Therefore, in order to better analyse these results, the velocity magnitude field and the energy spectrum are plotted in \figref{fig:deltales-pst-vmag} and \figref{fig:deltales-pst-espec} respectively.
Here, it can be observed from the velocity magnitude plot, that PST is absolutely necessary, particularly with a low $f_{pst}$ value, since without PST, the particles become clustered, and the flow field no longer represents the expected Taylor-Green vortex profile.
In the energy spectrum plot, it can be observed that the energy distribution at the final time instanc, has barely changed, indicating that the scheme appears to be conservative w.r.t energy, with or without PST. Therefore, long-time studies would be required to ascertain the effects of PST on the evolution of the energy spectrum.
...
The $k-\epsilon$ SPH scheme of \cite{Shao2006} was chosen over the other RANS-based schemes, since it was ...

K-EPS - EOS \figref{fig:keps-eos}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K-EPS - EOS VMAG \figref{fig:keps-eos-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K-EPS - EOS ESPEC \figref{fig:keps-eos-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K-EPS - K-EPS-EXPAND \figref{fig:keps-kexp-expand}
\begin{figure}[H]
  \begin{subfigure}{7cm}
    \centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/dt_pois_conv_c0_20_re_100.png}
    \caption{$Re = 100$}
  \end{subfigure}
  \begin{subfigure}{7cm}
    \centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/dt_pois_conv_c0_20_re_1000.png}
    \caption{$Re = 1000$}
  \end{subfigure}
  \begin{subfigure}{7cm}
    \centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/dt_pois_conv_c0_20_re_10000.png}
    \caption{$Re = 10000$}
  \end{subfigure}
  \caption{Convergence of the $k-\epsilon$ SPH scheme for simplified and expanded $k-\epsilon$ transport equations.}
  \label{fig:keps-kexp-expand}
\end{figure}


K-EPS - K-EPS-EXPAND VMAG \figref{fig:keps-kexp-expand-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
    \centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/c0_20_tait_pec_dtmul_1_kepx_no_nx_50_pst_100_re_10000_k_eps/final_vmag.png}
    \caption{Simplified $k-\epsilon$ transport equations}
  \end{subfigure}
  \begin{subfigure}{7cm}
	\centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/c0_20_tait_pec_dtmul_1_kepx_yes_nx_50_pst_100_re_10000_k_eps/final_vmag.png}
	\caption{Expanded $k-\epsilon$ transport equations}
\end{subfigure}
  \caption{Velocity magnitude field for the $k-\epsilon$ SPH scheme for simplified and expanded $k-\epsilon$ transport equations $(N=50^2, t_f=0.1, Re=10000, c_s=20, f_{pst}=10)$.}
  \label{fig:keps-kexp-expand-vmag}
\end{figure}


K-EPS - K-EPS-EXPAND ESPEC \figref{fig:keps-kexp-expand-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
    \centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/c0_20_tait_pec_dtmul_1_kepx_yes_nx_100_pst_100_re_10000_k_eps/energy_spectrum_evolution.png}
    \caption{Expanded $k-\epsilon$ transport equations}
  \end{subfigure}
  \begin{subfigure}{7cm}
    \centering\includegraphics[width=6cm]{Code-Figures/keps/expanded/c0_20_tait_pec_dtmul_1_kepx_no_nx_100_pst_100_re_10000_k_eps/energy_spectrum_evolution.png}
    \caption{Simplified $k-\epsilon$ transport equations}
  \end{subfigure}
  \caption{Evolution of the energy spectrum for the $k-\epsilon$ SPH scheme for expanded or simplified $k-\epsilon$ transport equations $(N=100^2, t_f=0.1, Re=10000, c_s=20, f_{pst}=10)$.}
  \label{fig:keps-kexp-expand-espec}
\end{figure}


K-EPS - PST \figref{fig:keps-pst}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K-EPS - PST VMAG \figref{fig:keps-pst-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K-EPS - PST ESPEC \figref{fig:keps-pst-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K - SPATIAL OOC \figref{fig:k-spatial-ooc}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
EPS - SPATIAL OOC \figref{fig:eps-spatial-ooc}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
K - SPATIAL OOC FIELD \figref{fig:k-spatial-ooc-field}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
EPS - SPATIAL OOC FIELD \figref{fig:eps-spatial-ooc-field}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - GRAD-CORR \figref{fig:sph-eps-grad-corr}  
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - GRAD-CORR VMAG \figref{fig:sph-eps-grad-corr-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - GRAD-CORR ESPEC \figref{fig:sph-eps-grad-corr-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - MEPS \figref{fig:sph-eps-meps}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - MEPS VMAG \figref{fig:sph-eps-meps-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - MEPS ESPEC \figref{fig:sph-eps-meps-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - EOS \figref{fig:sph-eps-eos}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - EOS VMAG \figref{fig:sph-eps-eos-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - EOS ESPEC \figref{fig:sph-eps-eos-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - PST \figref{fig:sph-eps-pst}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - PST VMAG \figref{fig:sph-eps-pst-vmag}
\begin{figure}[H]
  \begin{subfigure}{7cm}
...
SPH-EPS - PST ESPEC \figref{fig:sph-eps-pst-espec}
\begin{figure}[H]
  \begin{subfigure}{7cm}
