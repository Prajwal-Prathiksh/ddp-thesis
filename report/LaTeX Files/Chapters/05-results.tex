...
% TODO
% Implementation - PySPH, not efficient for large number of particles, since eigenvalues are being computed
% Results of BIT & FIT for configs
% Tracer particles as substitute
